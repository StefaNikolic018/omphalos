...
export default function index({ texts, selectedText, setSelectedText }: { texts: string[], selectedText: string | boolean, setSelectedText: React.Dispatch<React.SetStateAction<any>> }) {
